...
# -*- coding: utf-8 -*-
"""
「ポケスリ チーム編成ナビ」のデータを作って index.html を組み立てるプログラム。
...
FIELDS = [
    ...
    # シアンの砂浜EXは、メインだけが みず／フェアリー／ひこう から選ばれ、
    # のこりの2つは全タイプからランダムに決まる。
    # そのため types は None（自分で3つ選ぶ）にして、mainOnly でメインの候補を示す。
    {"n": "ワカクサ本島 EX", "types": None, "ex": "ggex"},
    {"n": "シアンの砂浜 EX", "types": None, "ex": "cbex",
     "mainOnly": ["みず", "フェアリー", "ひこう"]},
]
